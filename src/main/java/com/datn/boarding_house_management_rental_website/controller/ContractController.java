...
public class ContractController {
    ...
    private ResponseEntity<?> addContract(@RequestParam String name,
        ...
        return ResponseEntity.ok(contractService.addContract(name,roomId,nameOfRent, numOfPeople, phone
                ,deadlineContract,contractStatus,createdAt,files));
    }
    ...
    private ResponseEntity<?> updateContractInfo(@PathVariable Long id,
                                                 ...
                                                 @RequestParam ContractStatus contractStatus,
                                                 @RequestParam(required = false) List<MultipartFile> files) {
        return ResponseEntity.ok(contractService.editContractInfo(id, name, roomId, nameOfRent,numOfPeople, phone, deadlineContract, contractStatus,createdAt,files));
    }
    @DeleteMapping("/{id}")
