...
public interface BlogService {
    ...
    Page<RoomResponse> getAllRoomForCustomer(String title, BigDecimal price, Long category, String city, String district, String ward, LocalDateTime deadLineContract, Integer pageNo, Integer pageSize);
}
